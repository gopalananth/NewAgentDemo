/**
 * Theme Configuration - Blue and White Color Scheme
 * 
 * This file defines the main theme colors, typography, and design tokens
 * for the New Agent Demo Platform. The theme follows a professional
 * blue and white color scheme for a clean, modern look.
 */
...
export const componentThemes = {
  button: {
    primary: {
      ...
      bgActive: theme.colors.primary[700],
    ...
    secondary: {
      ...
      bgActive: theme.colors.neutral[100],
    ...
    outline: {
      ...
      bgActive: theme.colors.primary[100],
      text: theme.colors.primary[600],
      border: theme.colors.primary[300]
    }
  },
  ...
  sidebar: {
    bg: theme.colors.neutral.white,
    border: theme.colors.neutral[200],
    itemHover: theme.colors.primary[50],
    itemActive: theme.colors.primary[100],
    itemText: theme.colors.neutral[700],
    itemTextActive: theme.colors.primary[700]
  },
